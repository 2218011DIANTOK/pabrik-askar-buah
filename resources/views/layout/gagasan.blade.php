    ...
    <div class="main-content">
        ...
        <div class="tabel-wrapper">
            ...
            <div class="button-container">
                <button class="move-button" onclick="window.location.href='input'">Input Data</button>
            </div>
            <div class="tabel-container" id="data-container">
                <table>
                    ...
                    <tbody>
                       ...
                       <tr>
                        <td>{{$g->judul_gagasan}}</td>
                        <td>{{$g->narasi_gagasan}}</td>
                        <td>
                            <a href="/ubahgagasan/{{$g->id_gagasan}}" class="btn btn-warning">Edit</a>
                            <a href="/deletegagasan/{{$g->id_gagasan}}" class="btn btn-danger">Delete</a>
                        </td>
                       </tr>
                       @endforeach
                    </tbody>
