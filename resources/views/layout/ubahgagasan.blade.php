   ...
   onclick="event.preventDefault();
    ...
    <div class="main-content">
        ...
        <div class="tabel-wrapper">
            ...
            <form action="/updatedata/{{$gagasan->id_gagasan}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="judul_gagasan">Judul Gagasan</label>
                        <input type="text" id="judul_gagasan" name="judul_gagasan" value="{{$gagasan->judul_gagasan}}" />
                    </div>
                    <div class="form-group">
                        <label for="narasi_gagasan">Narasi Gagasan</label>
                        <textarea id="narasi_gagasan" name="narasi_gagasan" rows="4">{{$gagasan->narasi_gagasan}}</textarea>
                    </div>
                    <div class="form-group">
                    </div>
