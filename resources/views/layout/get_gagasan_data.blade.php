...
<body>
    ...
    <div class="main-content">
        ...
        <div class="tabel-wrapper">
            ...
            <div class="button-container">
                <button class="move-button" onclick="window.location.href='{{ route('admin.input') }}'">Input Data</button>
    ...
    <script>
        ...
        async function fetchData() {
            try {
                const response = await fetch('{{ route('gagasan.data') }}');
            ...
            data.forEach(item => {
                html += `
                    <tr>
                        ...
                        <td>
                            ${item.foto_dokumen ? `<img src="{{ asset('foto') }}/${item.foto_dokumen}" alt="Foto Dokumen" style="width: 100px;">` : 'Tidak ada foto'}
                        </td>
