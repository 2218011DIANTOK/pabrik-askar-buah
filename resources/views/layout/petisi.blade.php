    ...
    <div class="main-content">
        ...
        <div class="tabel-wrapper">
            ...
            <div class="button-container">
                <a class="move-button" href="tambahpetisi">Input Data</a>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                       ...
                       <tr>
                        ...
                        <td>
                            <a href="/ubahpetisi/{{$g->id_petisi}}" class="btn btn-warning">Edit</a>
                            <a href="/deletepetisi/{{$g->id_petisi}}" class="btn btn-danger">Delete</a>
                        </td>
                       </tr>
                       @endforeach
                    </tbody>
